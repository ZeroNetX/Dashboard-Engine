                          ...
                          child: Column(
                            children: [
                              ...
                              LayoutBuilder(builder: (context, cons) {
                                ...
                                List<String> assets = [
                                  '$iconsPath/github${siteUiController.currentTheme.value == AppTheme.Light ? '_dark' : ''}.png',
                                  '$iconsPath/twitter${siteUiController.currentTheme.value == AppTheme.Light ? '_dark' : ''}.png',
                                  '$iconsPath/facebook${siteUiController.currentTheme.value == AppTheme.Light ? '_dark' : ''}.png',
                                ];
                                List<String?> links = [
                ...
                for (var package in purchases) {
                  ...
                  children.add(
                    ElevatedButton(
                      ...
                      onPressed: () =>
                          siteUiController.zeroNetUserStatus.value ==
