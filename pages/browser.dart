...
class ZeroBrowser extends StatelessWidget {
  ...
  Color browserBgColor = siteUiController.currentTheme.value.browserBgColor;
  setTheme() {
    ...
    switch (zeroBrowserTheme) {
      ...
      case 'light':
        ...
        if (siteUiController.currentTheme.value == AppTheme.Dark ||
            siteUiController.currentTheme.value == AppTheme.Black)
  ...
  Widget build(BuildContext context) {
    ...
    bool fullScreenWebView =
        (siteUiController.settings[enableFullScreenOnWebView] as ToggleSetting?)
                ?.value ??
            false;
                ...
                body: InAppWebView(
                  ...
                  shouldOverrideUrlLoading: (ctrl, action) async {
                    ...
                    if (!(uri.toString()).startsWith(defZeroNetUrl) &&
                        !((siteUiController.settings[enableInternetAccess]
                                    as ToggleSetting?)
                                ?.value ??
                            false)) {
                    ...
                    children: <Widget>[
                      IconButton(
                        ...
                        color: siteUiController
                            .currentTheme.value.browserIconColor,
                        onPressed: () {
                          SystemChrome.setEnabledSystemUIMode(
                            SystemUiMode.manual,
                            overlays: [
