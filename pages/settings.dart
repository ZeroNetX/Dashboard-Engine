                  ...
                  Row(
                    children: <Widget>[
                      IconButton(
                        ...
                        onPressed: () {
                          showBottomSheet(
                            ...
                            elevation: 16.0,
                            backgroundColor:
                                siteUiController.currentTheme.value.cardBgColor,
                            builder: (ctx) {
                              return Container(
                      ...
                      if (setting is ToggleSetting)
                        Obx(
                          () {
                            bool enabled = (siteUiController
                                    .settings[setting.name] as ToggleSetting)
                                .value!;
                            return Switch(
                              value: enabled,
                        ...
                        child: Padding(
                          ...
                          child: Chip(
                            ...
                            backgroundColor: proFeatures.contains(element)
                                ? siteUiController
                                    .currentTheme.value.premiumOptionColor
                                : siteUiController
                      ...
                      children.insert(
                        ...
                        InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Chip(
                              elevation: 2.0,
                              backgroundColor: siteUiController
                                  .currentTheme.value.cardBgColor,
                              label: Text(
                                language,
                                maxLines: 1,
